...
990 entries · last refreshed 2026-09-23
...
- [langchain-loadout](https://github.com/deyna256/langchain-loadout) ([site](https://pypi.org/project/langchain-loadout/)) - Per-turn skill selection for LangChain and deepagents agents: a fast judge picks the few skills a turn needs, so a catalog of hundreds stays out of the prompt.
